...
def build_report_spec(
    ...
    cards = [
        {
            "id": "genes",
            "description": "Genes from the supervisor candidate list with complete fine-tuned scans.",
            "dataset": "summary",
            "sourceId": "candidate_summary",
            "metrics": [
                {"label": "Genes completed", "field": "genes", "format": "number"}
            ],
        },
        {
            "id": "segments",
            "description": "Two non-splice candidate regions retained per gene.",
            "dataset": "summary",
            "sourceId": "candidate_summary",
            "metrics": [
                {"label": "Candidate segments", "field": "segments", "format": "number"}
            ],
        },
        {
            "id": "hsc_segments",
            "description": "Selection-conditioned candidates whose HSC head ranks first in both fine-tuned models at the chosen readout.",
            "dataset": "summary",
            "sourceId": "candidate_summary",
            "metrics": [
                {
                    "label": "HSC-top in both",
                    "field": "both_hsc_segments",
                    "format": "number",
                }
            ],
        },
        {
            "id": "mutations",
            "description": "Strict composition-preserving 10-bp shuffles across the 18 original-model candidate segments.",
            "dataset": "summary",
            "sourceId": "candidate_summary",
            "metrics": [
                {
                    "label": "Candidate edits",
                    "field": "candidate_mutations",
                    "format": "number",
                }
            ],
        },
        {
            "id": "storage",
            "description": "Largest actual run directory; the user-defined limit is 3 GB per study.",
            "dataset": "summary",
            "sourceId": "pipeline_validation",
            "metrics": [
                {
                    "label": "Largest run",
                    "field": "largest_run_gb",
                    "format": "number",
                    "unit": "GB",
                }
            ],
    ...
    charts = [
        {
            "id": "hsc_ratio",
            "title": "HSC effect relative to the strongest non-HSC head",
            "subtitle": "Selected readout per segment; ratio uses median absolute log2 ratio-of-sums across the retained edits.",
            "type": "bar",
            "dataset": "hsc_ratio",
            "sourceId": "candidate_summary",
            "layout": "full",
            ...
            "yAxisTitle": "HSC / max other",
            "valueFormat": "number",
        },
        {
            "id": "fine_heatmap",
            "title": "Four-cell fine-tuned effect matrix",
            "subtitle": "Median absolute edit effect at each segment's selected readout; rows separate model architecture.",
            "type": "heatmap",
            "dataset": "fine_cell_matrix",
            "sourceId": "candidate_summary",
            "layout": "full",
            "encodings": {
                "x": {"field": "cell_label", "type": "nominal", "label": "Cell head"},
                "y": {
                    "field": "median_abs_effect",
                    "type": "quantitative",
                    "label": "Median |effect|",
                },
                "color": {
        ...
        {
            "id": "mdk_robustness",
            "title": "Mdk +441..+507 HSC-selectivity margin across shuffle manifests",
            "subtitle": "34 aligned centers; positive values indicate HSC effect exceeds all three non-HSC heads.",
            "type": "line",
            "dataset": "mdk_centers",
            "sourceId": "mdk_robustness",
            "layout": "full",
            "encodings": {
                "x": {
                    "field": "variant_offset_from_tss_transcription_bp",
                    "type": "quantitative",
                    "label": "TSS offset (bp, transcription direction)",
                },
                "y": {
                    "field": "hsc_margin",
                    "type": "quantitative",
                    "label": "HSC selectivity margin",
                },
                "color": {
                    "field": "series",
                    "type": "nominal",
            ...
            "yAxisTitle": "HSC margin",
            "valueFormat": "number",
        },
        {
            "id": "original_top",
            "title": "Strongest original-model track-group effect per candidate",
            "subtitle": "Maximum median absolute effect among curated RNA, CAGE, accessibility, active-chromatin and TF groups; original tracks are cell-type proxies, not matched Saijou heads.",
            "type": "bar",
            "dataset": "original_top",
            "sourceId": "original_comparison",
            "layout": "full",
            "encodings": {
                "x": {
                    "field": "segment_label",
                ...
                "y": {
                    "field": "abs_effect",
                    "type": "quantitative",
                    "label": "Top original median |effect|",
                },
                "color": {
                    "field": "model",
                    "type": "nominal",
            ...
            "settings": {"orientation": "horizontal", "groupMode": "grouped"},
            "yAxisTitle": "Median |effect|",
            "valueFormat": "number",
        },
        {
            "id": "storage_runs",
            "title": "Actual storage per canonical run",
            "subtitle": "Four validated run directories; the hard study budget is 3 GB per run.",
            "type": "bar",
            "dataset": "validation",
            "sourceId": "pipeline_validation",
            "layout": "full",
    ...
    tables = [
        {
            "id": "controls",
            "title": "Acta2 and Col1a1 motif positive controls",
            "subtitle": "Best HSC-readout percentile for the exact 10-bp control window; motif disruption is computed from JASPAR2024 hits overlapping the edit.",
            "dataset": "controls",
            "sourceId": "candidate_summary",
            "layout": "full",
            "density": "spacious",
            "defaultSort": {"field": "percentile", "direction": "desc"},
            "columns": [
                {"field": "gene", "label": "Gene", "type": "text"},
                {"field": "control", "label": "Control", "type": "text"},
                {"field": "model", "label": "Fine-tuned model", "type": "text"},
                {"field": "readout_role", "label": "Best readout", "type": "text"},
                {"field": "center", "label": "TSS offset", "format": "number"},
                {"field": "rank", "label": "Rank", "format": "number"},
                {"field": "centers_total", "label": "Centers", "format": "number"},
                {"field": "percentile", "label": "Percentile", "format": "percent"},
                {"field": "motif_family", "label": "Motif family", "type": "text"},
                {
                    "field": "motif_max_abs_score_change",
                    "label": "Max motif score change",
                    "format": "number",
                },
            ],
        },
        {
            "id": "candidate_table",
            "title": "Eighteen retained candidate segments",
            "subtitle": "Exact candidate location, transcript context, fine-tuned HSC ratios, top original track groups, motif family and splice distance.",
            "dataset": "overview",
            "sourceId": "candidate_summary",
            "layout": "full",
            "density": "dense",
            "defaultSort": {"field": "hsc_vs_max_other_ratio_bz", "direction": "desc"},
            "columns": [
                {"field": "segment_label", "label": "Segment", "type": "text"},
                {"field": "peak_region_type", "label": "Region", "type": "text"},
                {
                    "field": "peak_transcript_feature",
                    "label": "Transcript feature",
                    "type": "text",
                },
                {"field": "tested_centers", "label": "Centers", "format": "number"},
                {
                    "field": "minimum_splice_distance_bp",
                    "label": "Nearest splice (bp)",
                    "format": "number",
                },
                {
                    "field": "hsc_vs_max_other_ratio_ag",
                    "label": "AG HSC ratio",
                    "format": "number",
                },
                {
                    "field": "hsc_vs_max_other_ratio_bz",
                    "label": "BZ HSC ratio",
                    "format": "number",
                },
                {"field": "top_cell_ag", "label": "AG top", "type": "text"},
                {"field": "top_cell_bz", "label": "BZ top", "type": "text"},
                {
                    "field": "top_motif_family",
                    "label": "Top motif family",
                    "type": "text",
                },
                {
                    "field": "top_original_group_ag",
                    "label": "AG-original top",
                    "type": "text",
                },
                {
                    "field": "top_original_group_bz",
                    "label": "BZ-original top",
                    "type": "text",
                },
            ],
        },
        {
            ...
            "title": "Gene-by-gene interpretation and action",
            "subtitle": "Biological interpretation combines the selected edit evidence, original-model proxies, motif annotation and transcript caveats.",
            "dataset": "gene_interpretation",
            "sourceId": "candidate_summary",
            "layout": "full",
            "density": "spacious",
            "defaultSort": {"field": "gene", "direction": "asc"},
            "columns": [
                {"field": "gene", "label": "Gene", "type": "text"},
                {"field": "candidate", "label": "Focus", "type": "text"},
                {"field": "interpretation", "label": "Interpretation", "type": "text"},
            ],
        },
        {
            "id": "original_evidence",
            "title": "Top original-model evidence per candidate",
            "subtitle": "Exact strongest group, signed effect and reference activity at the selected readout; values are model-specific and should not be compared as calibrated assay units.",
            "dataset": "original_top",
            "sourceId": "original_comparison",
            "layout": "full",
            "density": "dense",
            "defaultSort": {"field": "abs_effect", "direction": "desc"},
            "columns": [
                {"field": "segment_label", "label": "Segment", "type": "text"},
                {"field": "model", "label": "Original model", "type": "text"},
                {"field": "track_group", "label": "Top track group", "type": "text"},
                {"field": "abs_effect", "label": "Median |effect|", "format": "number"},
                {
                    "field": "signed_effect",
                    "label": "Signed effect",
                    "format": "number",
        ...
        {
            "id": "motifs",
            "title": "Top three canonical motif families per candidate",
            "subtitle": "Family labels are sequence hypotheses; shared PWMs prevent single-factor assignment without orthogonal occupancy data.",
            "dataset": "motif_top",
            "sourceId": "motif_scan",
            "layout": "full",
            "density": "dense",
            "defaultSort": {"field": "max_abs_score_change", "direction": "desc"},
            "columns": [
                {"field": "segment_label", "label": "Segment", "type": "text"},
                {"field": "family", "label": "Family", "type": "text"},
                {"field": "family_rank", "label": "Rank", "format": "number"},
                {
                    "field": "affected_centers",
                    "label": "Affected centers",
                    "format": "number",
                },
                {
                    "field": "max_abs_score_change",
                    "label": "Max score change",
                    "format": "number",
                },
            ],
        },
        {
            "id": "transcripts",
            "title": "Representative transcript audit",
            "subtitle": "Transcript used for splice exclusion and feature annotation; non-basic/retained-intron entries require coordinate re-check before wet-lab design.",
            "dataset": "transcripts",
            ...
            "columns": [
                {"field": "gene", "label": "Gene", "type": "text"},
                {
                    "field": "representative_transcript_id",
                    "label": "Transcript",
                    "type": "text",
                },
                {"field": "transcript_name", "label": "Name", "type": "text"},
                {"field": "transcript_biotype", "label": "Biotype", "type": "text"},
                {"field": "transcript_support_level", "label": "TSL", "type": "text"},
                {"field": "is_basic", "label": "Basic", "type": "boolean"},
                {"field": "has_ccds_tag", "label": "CCDS", "type": "boolean"},
                {
                    "field": "tss_matches_analysis",
                    "label": "TSS matched",
                    "type": "boolean",
                },
            ],
        ...
        {
            "id": "validation",
            "title": "Run completeness, storage and profile reconstruction",
            "subtitle": "All runs use 128-bp float16 log2FC storage; the acceptance threshold is 0.2% relative ALT-sum reconstruction error and 3 GB per run.",
            "dataset": "validation",
            "sourceId": "pipeline_validation",
            "layout": "full",
            "density": "dense",
            "defaultSort": {"field": "run_megabytes", "direction": "desc"},
            "columns": [
                {"field": "run", "label": "Run", "type": "text"},
                {"field": "genes", "label": "Genes", "format": "number"},
                {"field": "tracks", "label": "Tracks", "format": "number"},
                {"field": "run_megabytes", "label": "Run MB", "format": "number"},
                {
                    "field": "profile_megabytes",
                    "label": "Profile MB",
                    "format": "number",
                },
                {
                    "field": "max_reconstruction_relative_error",
                    "label": "Max reconstruction error",
                    "format": "percent",
                },
                {
                    "field": "profile_nonfinite_values",
                    "label": "Nonfinite",
                    "format": "number",
                },
                {
                    "field": "profile_index_mismatches",
                    "label": "Index mismatches",
                    "format": "number",
                },
                {"field": "under_3gb", "label": "Under 3 GB", "type": "boolean"},
            ],
        },
        {
            "id": "mdk_hub",
            "title": "Mdk broad-hub robustness summary",
            "subtitle": "+441..+507 aggregated over 34 aligned centers in the final Mdk audit and the independent nine-gene manifest.",
            "dataset": "mdk_hub",
            "sourceId": "mdk_robustness",
            "layout": "full",
            "density": "dense",
            "defaultSort": {"field": "hsc_vs_max_other_ratio", "direction": "desc"},
            "columns": [
                {"field": "manifest_label", "label": "Manifest", "type": "text"},
                {"field": "model", "label": "Model", "type": "text"},
                {"field": "centers", "label": "Centers", "format": "number"},
                {
                    "field": "hsc_vs_max_other_ratio",
                    "label": "HSC ratio",
                    "format": "number",
                },
                {
                ...
                {
                    "field": "hsc_top_center_fraction",
                    "label": "HSC-top fraction",
                    "format": "percent",
                },
            ],
        },
    ...
    blocks = [
        ...
        },
        {
            "id": "fine_heatmap_ag",
            "type": "html",
            "body": static_figures["fine_heatmap_ag"],
        },
        {
            "id": "fine_heatmap_bz",
            "type": "html",
            "body": static_figures["fine_heatmap_bz"],
        },
        {
            "id": "signed_browser_heading",
            "type": "markdown",
            "sourceId": "fine_scan",
            "body": "## 九基因全扫描的 signed effect 可直接读取方向与幅度\n\n每个中心显示四个预设 HSC readout 中 median absolute response 最大者所对应的 signed median `log2(mutant/reference)`；粗线为五个相邻中心的 rolling median。零线以下表示突变降低预测输出，以上表示提高。每个基因使用独立的对称纵轴，因此该图适合在基因内定位和读效应方向，不把跨架构数值当作已校准测量，也不把三条 shuffle 当作生物学重复。",
        },
        {
            "id": "signed_browser_chart",
            "type": "html",
            "body": static_figures["fine_signed_browser"],
        },
        {
            "id": "controls_heading",
            "type": "markdown",
            "body": "## 正控恢复成功，但效应依赖模型与 readout\n\nActa2 -61 的 SRF/CArG 窗在 AlphaGenome HSC/TSS 排 7/508，在 Borzoi 最佳 readout 排 40/508；JASPAR SRF score 在 3/3 centers 被扰动。Col1a1 -71 的 NF-Y/CCAAT 窗在 AlphaGenome 与 Borzoi 分别排 8/508 和 14/508，NFYA/B/C score change 为 11.53–14.48。正控定位成立，但它们在四细胞头中并不 HSC-first，这正好校准了主问题。",
        },
        {
            "id": "controls_table",
            "type": "table",
