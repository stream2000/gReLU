...
Read [AGENTS.md](AGENTS.md). It is the guide for this repository and applies to
Claude Code as written; this file exists only to point at it.

Nested guides take precedence for their own subtree:
